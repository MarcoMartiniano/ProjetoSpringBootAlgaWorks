...
import com.example.login.domain.ValidationGroups;
...
public class OrdemServico {
	...
	//se for difente do nome da classe
	//@JoinColumn(name = "clienteid")
	// valid validar as proprietades dentro do clientes
	@Valid
	...
	public boolean podeSerFinalizada() {
		return StatusOrdemServicos.ABERTA.equals(getStatus());		
	}
	...
	public void finalizar() {
		...
		setStatus(StatusOrdemServicos.FINALIZADA);
